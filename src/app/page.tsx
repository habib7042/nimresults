                ...
                {showResults && results.length > 0 && (
                  <div className="mt-8 print:shadow-none">
                    ...
                    <div className="hidden print:block text-center mb-6">
                      <h1 className="text-2xl font-bold">বিদ্যালয় ফলাফল ব্যবস্থাপনা</h1>
                      <p className="text-lg">School Result Management System</p>
                      <div className="mt-4">
                        <h3 className="text-xl font-semibold">Student Information</h3>
                        <p>Name: {results[0].student.name}</p>
                        <p>Roll: {results[0].student.rollNumber}</p>
                    ...
                    <div className="hidden print:block mt-8 text-center text-sm text-gray-600">
                      ...
                      <p className="mt-2">© 2024 School Result Management System</p>
                    </div>
                  </div>
                )}
